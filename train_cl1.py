...
# Model parameters
emb_dim = 2600  # dimension of word embeddings
...
def train(train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    # Batches
    for i, (imgs, caps, txt_feature, caplens) in enumerate(train_loader):
...
def validate(val_loader, encoder, decoder, criterion):
    ...
    # Batches
    for i, (imgs, caps, txt_feature, caplens, allcaps) in enumerate(val_loader):
